...
class BaseModel
{
     ...
     * @param \GatotKaca\Core\Helper\Helper $helper
     **/
    public function __construct(\Doctrine\ORM\EntityManager $em = null, \GatotKaca\Core\Helper\Helper $helper = null)
    {
        $this->em     = $em;
        $this->helper = $helper;
        $this->action = 'ACCESS';
     ...
     * @param \GatotKaca\Core\Helper\Helper $helper
     **/
    public function setHelper(\GatotKaca\Core\Helper\Helper $helper)
    {
        $this->helper = $helper;
    }
     ...
     * Get helper
     *
     * @return \GatotKaca\Core\Helper\Helper $helper
     **/
