...
class CountryModel extends BaseModel
{
    ...
    public function getList($keyword, $start, $limit)
    {
        ...
        $query  = $this->getEntityManager()
            ...
            ->select(
                ...
                c.phone_code AS country_phonecode'
            )
    ...
    private function checkExist($entity, $code, $phonecode)
    {
        ...
        $countryPhone   = $this->getEntityManager()->getRepository('GatotKacaErpMainBundle:Country')->findOneBy(array('phone_code' => $phonecode));
        if ($countryCode) {
